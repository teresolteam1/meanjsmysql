        ...
        copy: {
            ...
            js: {
                files: [
                    ...
                    {cwd: 'bower_components/bootstrap-css/css',                  src: ['*.*'],    dest: 'public/lib/bootstrap/css', expand: true},
                    {cwd: 'bower_components/bootstrap-css/ico',                  src: ['*.*'],    dest: 'public/lib/bootstrap/ico', expand: true},
                    {cwd: 'bower_components/bootstrap-css/img',                  src: ['*.*'],    dest: 'public/lib/bootstrap/img', expand: true},
